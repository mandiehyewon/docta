...
label_path = './data/cifar/noise_label_human.pt'
noisy_label_key = 'noise_label_train'
clean_label_key = 'clean_label_train'
label_sel = 1 # which label/attribute we want to diagnose
train_label_sel = label_sel # 1 for noisy
test_label_sel = train_label_sel

file_name = 'c10_VITB_Rank'
dataset_type += '_' + file_name
save_path = f'./results/{dataset_type}/VITB_Rank/'
